...
/**
 * Callback Interface for an SBB that uses the {@link PublicationClientControlSbbLocalObject} as a child. 
 * @author martins
 *
 */
public interface PublicationClientControlParentSbbLocalObject extends SbbLocalObject {
	 ...
	 * @param expires
	 */
	public void newPublicationOk(Object requestId,String eTag,int expires) throws Exception;
	 ...
	 * @param expires
	 */
	public void refreshPublicationOk(Object requestId,String eTag,int expires) throws Exception;
	 ...
	 * @param expires
	 */
	public void modifyPublicationOk(Object requestId,String eTag,int expires) throws Exception;
	 ...
	 * @param requestId
	 * @param error sip matching error status code 
	 */
