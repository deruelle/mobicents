...
public class Watcherinfo {
    ...
    @XmlElement(name = "watcher-list")
    protected List<WatcherList> watcherList;
     ...
     * This is why there is not a <CODE>set</CODE> method for the watcherList property.
     * 
     * <p>
    ...
    public List<WatcherList> getWatcherList() {
        if (watcherList == null) {
            watcherList = new ArrayList<WatcherList>();
        }
