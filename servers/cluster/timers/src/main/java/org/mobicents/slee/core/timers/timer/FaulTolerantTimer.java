...
public class FaulTolerantTimer extends java.util.Timer {
	 ...
	 * @param txManager
	 */
	public FaulTolerantTimer(FaultTolerantScheduler scheduler) {
		 this.scheduler = scheduler;
		 //be carefull, this can cause errors, if there is someone else using this scheduler.
		 this.scheduler.setTimerTaskFactory(this.timerTaskFactory);
	}
