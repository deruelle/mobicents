 ...
 *
 */
public abstract class ClusteredSipStack extends gov.nist.javax.sip.SipStackImpl {
	...
	public ClusteredSipStack(Properties configurationProperties) throws PeerUnavailableException {
