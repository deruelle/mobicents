...
public class Codec extends ServiceMBeanSupport implements CodecMBean {
    ...
    private SpeexFactory codecFactory;
    private Mode mode;
    private int quality;
    ...
    public void startService() throws Exception {
        logger.info("Deploying codec: Speex");
        codecFactory = new SpeexFactory();
        rebind();
    }    
    ...
    public void stopService() {
        unbind(jndiName);
        logger.info("Undeployed codec: Speex ");
    }
    ...
    private void rebind() throws NamingException {
        ...
        logger.info("Deployed codec: Speex, jndi=" + this.jndiName);
    }
