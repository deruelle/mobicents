...
public class Codec extends ServiceMBeanSupport implements CodecMBean {
    ...
    private G711Factory codecFactory;
    ...
    public void startService() throws Exception {
        logger.info("Deploying codec: G.711");
        codecFactory = new G711Factory();
        rebind();
    }    
    ...
    public void stopService() {
        unbind(jndiName);
        logger.info("Undeployed codec: G711 ");
    }
    ...
    private void rebind() throws NamingException {
        ...
        logger.info("Deployed codec: G.711, jndi=" + this.jndiName);
    }
