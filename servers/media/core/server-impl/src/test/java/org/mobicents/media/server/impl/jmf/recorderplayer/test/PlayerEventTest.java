...
public class PlayerEventTest extends EventSuperCase {
	...
	// PlayerEventType[] sequence = new
	// PlayerEventType[]{PlayerEventType.STARTED, PlayerEventType.END_OF_MEDIA};
	...
	// PlayerEventType[] sequence = new PlayerEventType[] {
	// PlayerEventType.STARTED, PlayerEventType.STOP_BY_REQUEST };
	// super.currentListener.setExpectedQueue(sequence);
	// super.setUpFiles("wav", true);
	// ap.start(recordFile.toURL().toString());
	// ap.stop();
