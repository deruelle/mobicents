...
public class AudioFormat extends Format {
    ...
    public static final String DOLBYAC3 = "dolbyac3";    // TODO: these are not used in this impl, only added for serialization
    // compatibility.
    ...
    public boolean matches(Format format) {
        ...
        final boolean result = FormatUtils.matches(this.sampleRate,
                oCast.sampleRate) && FormatUtils.matches(this.sampleSizeInBits,
                oCast.sampleSizeInBits) && FormatUtils.matches(this.channels, oCast.channels) && FormatUtils.matches(this.endian, oCast.endian) && FormatUtils.matches(this.signed, oCast.signed) && FormatUtils.matches(this.frameSizeInBits,
                oCast.frameSizeInBits) && FormatUtils.matches(this.frameRate, oCast.frameRate);
