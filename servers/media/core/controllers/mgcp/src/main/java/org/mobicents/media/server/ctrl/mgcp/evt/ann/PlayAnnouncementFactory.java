...
import org.mobicents.media.server.ctrl.mgcp.evt.MgcpSignalFactory;

/**
 *
 * @author kulikov
 */
public class PlayAnnouncementFactory implements MgcpSignalFactory {
    ...
    public MgcpSignal getInstance(String parms) {
        return new PlayAnnouncement(name, parms);
    }
}
