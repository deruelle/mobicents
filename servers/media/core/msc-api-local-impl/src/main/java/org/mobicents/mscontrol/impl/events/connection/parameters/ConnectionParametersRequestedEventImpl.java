 ...
 * @author Oleg Kulikov
 */
public class ConnectionParametersRequestedEventImpl extends BaseRequestedEvent implements MsConnectionParametersRequestedEvent {
    ...
    public RequestedEvent convert() {
        ...
        try {
            ConnectionParametersRequestedEvent evt = (ConnectionParametersRequestedEvent) factory.createRequestedEvent(
