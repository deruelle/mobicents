...
public abstract class DtmfDemoSbb implements Sbb {
	...
	private final static String WELCOME_MSG = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/welcome.wav";
	private final static String DTMF_0 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf0.wav";
	private final static String DTMF_1 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf1.wav";
	private final static String DTMF_2 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf2.wav";
	private final static String DTMF_3 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf3.wav";
	private final static String DTMF_4 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf4.wav";
	private final static String DTMF_5 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf5.wav";
	private final static String DTMF_6 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf6.wav";
	private final static String DTMF_7 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf7.wav";
	private final static String DTMF_8 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf8.wav";
	private final static String DTMF_9 = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/dtmf9.wav";
	private final static String STAR = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/star.wav";
	private final static String POUND = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/pound.wav";
	private final static String A = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/A.wav";
	private final static String B = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/B.wav";
	private final static String C = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/C.wav";
	private final static String D = "http://" + System.getProperty("jboss.bind.address", "127.0.0.1")
			+ ":8080/msdemo/audio/D.wav";
	...
	public void onAnnouncementComplete(MsNotifyEvent evt, ActivityContextInterface aci) {
		...
		MsEventFactory factory = msProvider.getEventFactory();
		MsDtmfRequestedEvent dtmf = (MsDtmfRequestedEvent) factory.createRequestedEvent(DTMF.TONE);
		MsRequestedSignal[] signals = null;
		MsDtmfRequestedSignal dtmfSignal = null;
		if (this.getStar()) {
			dtmfSignal = (MsDtmfRequestedSignal) factory.createRequestedSignal(DTMF.TONE);
			dtmfSignal.setTone("1");
			signals = new MsRequestedSignal[] { dtmfSignal };
		} else {
			signals = new MsRequestedSignal[] {};
		}
	...
	public abstract void setStar(boolean start);
