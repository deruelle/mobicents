...
public class MedGroConfPlaRecSigDetGen implements MediaGroupConfig {

	private static MediaGroupConfig medGroConfPlayer = new MedGroConfPlaRecSigDetGen();
	...
	static {
		...
		suppSymbols.add(MediaGroupParameterEnum.SG_SUPPORTED);
	}

	private MedGroConfPlaRecSigDetGen() {
	}
