...
public class DTMFGenPkg extends MegacoPkg {
	 ...
	 * @return Since this packge extends MEGACO Tone Generator package, this shall return value {@link PkgConsts.TONE_GEN_PACKAGE}.
	 */
	 ...
	 * @return Constant value {@link PkgConsts.BASIC_DTMF_GEN_PACKAGE} indicating DTMF Generator Package.
	 */
	public int getPkgId() {
