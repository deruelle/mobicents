...
public class ToneParamDur extends PkgItemParam {
	 ...
	 * 
	 * @return The integer values corresponding to start tone detected, end tone detected and long tone detected. Thus this shall return a vector containing the elements   {@link ToneEtdEvent.TONE_DET_ETD_EVENT} and
