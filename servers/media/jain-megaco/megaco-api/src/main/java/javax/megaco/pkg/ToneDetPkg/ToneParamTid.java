...
/**
 * The MEGACO parameter class for the ToneId Parameter is associated with Start
 * Tone Detect, Long Tone Detect and End Tone Detect event of Network Package.
 * This class defines all the static information for this parameter.
 */
public class ToneParamTid extends PkgItemParam {

	/**
	 * Identifies Duration parameter of the MEGACO Tone Detect Package. Its
	 * value shall be set equal to 0x0003.
	 */
	public static final int TONE_DET_PARAM_TID = 0x0003;
	 ...
	 * 
	 * @return paramId - Returns param id as {@link TONE_DET_PARAM_TID}.
	 */
