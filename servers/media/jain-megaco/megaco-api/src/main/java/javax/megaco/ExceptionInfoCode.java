...
public class ExceptionInfoCode {
	...
	public static final ExceptionInfoCode INV_IP_ADDR_FORMAT = new ExceptionInfoCode(
			M_INV_IP_ADDR_FORMAT);

	public static final ExceptionInfoCode INV_MTP3B_ADDR_FORMAT = new ExceptionInfoCode(
			M_INV_MTP3B_ADDR_FORMAT);

	public static final ExceptionInfoCode INV_AAL5_ADDR_FORMAT = new ExceptionInfoCode(
			M_INV_AAL5_ADDR_FORMAT);

	public static final ExceptionInfoCode INV_LOCAL_ADDR = new ExceptionInfoCode(
			M_INV_LOCAL_ADDR);

	public static final ExceptionInfoCode INV_REMOTE_ADDR = new ExceptionInfoCode(
			M_INV_REMOTE_ADDR);

	public static final ExceptionInfoCode INV_ERROR_CODE = new ExceptionInfoCode(
			M_INV_ERROR_CODE);

	public static final ExceptionInfoCode INV_EVT_STATUS_VAL = new ExceptionInfoCode(
			M_INV_EVT_STATUS_VAL);

	public static final ExceptionInfoCode INV_REQ_ID = new ExceptionInfoCode(
			M_INV_REQ_ID);

	public static final ExceptionInfoCode MISSING_EVT_PARAM = new ExceptionInfoCode(
			M_MISSING_EVT_PARAM);

	public static final ExceptionInfoCode MISSING_PKG_NAME = new ExceptionInfoCode(
			M_MISSING_PKG_NAME);

	public static final ExceptionInfoCode MISSING_ITEM_NAME = new ExceptionInfoCode(
			M_MISSING_ITEM_NAME);

	public static final ExceptionInfoCode MISSING_PKG_PARAM = new ExceptionInfoCode(
			M_MISSING_PKG_PARAM);

	public static final ExceptionInfoCode MISSING_INFO_IN_OBJ = new ExceptionInfoCode(
			M_MISSING_INFO_IN_OBJ);

	public static final ExceptionInfoCode BOTH_KA_EMBEDSIG_PRESENT = new ExceptionInfoCode(
			M_BOTH_KA_EMBEDSIG_PRESENT);

	public static final ExceptionInfoCode INV_STREAM_ID = new ExceptionInfoCode(
			M_INV_STREAM_ID);

	public static final ExceptionInfoCode INV_TIMER_VAL = new ExceptionInfoCode(
			M_INV_TIMER_VAL);

	public static final ExceptionInfoCode INV_DIGIT_VAL = new ExceptionInfoCode(
			M_INV_DIGIT_VAL);

	public static final ExceptionInfoCode NULL_OBJ_REF_PASSED = new ExceptionInfoCode(
			M_NULL_OBJ_REF_PASSED);

	public static final ExceptionInfoCode INV_SIGNAL_LIST_ID = new ExceptionInfoCode(
			M_INV_SIGNAL_LIST_ID);

	public static final ExceptionInfoCode MISSING_SIGNAL_LIST_ID = new ExceptionInfoCode(
			M_MISSING_SIGNAL_LIST_ID);

	public static final ExceptionInfoCode INV_OPR_ON_SIGNAL_PARAM = new ExceptionInfoCode(
			M_INV_OPR_ON_SIGNAL_PARAM);

	public static final ExceptionInfoCode INV_SIGNAL_DURATION = new ExceptionInfoCode(
			M_INV_SIGNAL_DURATION);

	public static final ExceptionInfoCode BOTH_STREAM_PARAM_DESC_PRESENT = new ExceptionInfoCode(
			M_BOTH_STREAM_PARAM_DESC_PRESENT);

	public static final ExceptionInfoCode INV_SDP_PARAM = new ExceptionInfoCode(
			M_INV_SDP_PARAM);

	public static final ExceptionInfoCode MISSING_MEDIA_STREAM_PARAM = new ExceptionInfoCode(
			M_MISSING_MEDIA_STREAM_PARAM);

	public static final ExceptionInfoCode MISSING_STREAM_ID = new ExceptionInfoCode(
			M_MISSING_STREAM_ID);

	public static final ExceptionInfoCode MISSING_EXTENSION_PARAM = new ExceptionInfoCode(
			M_MISSING_EXTENSION_PARAM);

	public static final ExceptionInfoCode INV_PROTOCOL_VERSION = new ExceptionInfoCode(
			M_INV_PROTOCOL_VERSION);

	public static final ExceptionInfoCode INV_DATE_STRING = new ExceptionInfoCode(
			M_INV_DATE_STRING);

	public static final ExceptionInfoCode INV_TIME_STRING = new ExceptionInfoCode(
			M_INV_TIME_STRING);

	public static final ExceptionInfoCode INV_MEDIA_DESC = new ExceptionInfoCode(
			M_INV_MEDIA_DESC);

	public static final ExceptionInfoCode INV_DIGITMAP_DESC = new ExceptionInfoCode(
			M_INV_DIGITMAP_DESC);

	public static final ExceptionInfoCode INV_PKG_DESC = new ExceptionInfoCode(
			M_INV_PKG_DESC);

	public static final ExceptionInfoCode INV_CNTX_TERM_AUDIT_DESC = new ExceptionInfoCode(
			M_INV_CNTX_TERM_AUDIT_DESC);

	public static final ExceptionInfoCode ERROR_DESC_ALRDY_PRESENT = new ExceptionInfoCode(
			M_ERROR_DESC_ALRDY_PRESENT);

	public static final ExceptionInfoCode TERMID_LIST_ALRDY_PRESENT = new ExceptionInfoCode(
			M_TERMID_LIST_ALRDY_PRESENT);

	public static final ExceptionInfoCode INV_YEAR_VAL = new ExceptionInfoCode(
			M_INV_YEAR_VAL);

	public static final ExceptionInfoCode INV_MONTH_VAL = new ExceptionInfoCode(
			M_INV_MONTH_VAL);

	public static final ExceptionInfoCode INV_DAY_VAL = new ExceptionInfoCode(
			M_INV_DAY_VAL);

	public static final ExceptionInfoCode INV_HOUR_VAL = new ExceptionInfoCode(
			M_INV_HOUR_VAL);

	public static final ExceptionInfoCode INV_MINUTES_VAL = new ExceptionInfoCode(
			M_INV_MINUTES_VAL);

	public static final ExceptionInfoCode INV_SECONDS_VAL = new ExceptionInfoCode(
			M_INV_SECONDS_VAL);

	public static final ExceptionInfoCode INV_ASSOCIATED_PKD_ID = new ExceptionInfoCode(
			M_INV_ASSOCIATED_PKD_ID);

	public static final ExceptionInfoCode INV_PKG_ITEM_PARAM = new ExceptionInfoCode(
			M_INV_PKG_ITEM_PARAM);

	public static final ExceptionInfoCode INV_RETURN_STATUS_VALUE = new ExceptionInfoCode(
			M_INV_RETURN_STATUS_VALUE);

	public static final ExceptionInfoCode INV_ASSOC_EVENT_TYPE = new ExceptionInfoCode(
			M_INV_ASSOC_EVENT_TYPE);

	public static final ExceptionInfoCode INV_ASSOC_IND_REASON = new ExceptionInfoCode(
			M_INV_ASSOC_IND_REASON);

	public static final ExceptionInfoCode INV_ASSOC_STATE = new ExceptionInfoCode(
			M_INV_ASSOC_STATE);

	public static final ExceptionInfoCode INV_ENC_FORMAT = new ExceptionInfoCode(
			M_INV_ENC_FORMAT);

	public static final ExceptionInfoCode INV_SVC_CHNG_METHOD = new ExceptionInfoCode(
			M_INV_SVC_CHNG_METHOD);

	public static final ExceptionInfoCode INV_SVC_CHNG_REASON = new ExceptionInfoCode(
			M_INV_SVC_CHNG_REASON);

	public static final ExceptionInfoCode INV_TPT_TYPE = new ExceptionInfoCode(
			M_INV_TPT_TYPE);

	public static final ExceptionInfoCode INV_CMD_REQ_TYPE = new ExceptionInfoCode(
			M_INV_CMD_REQ_TYPE);

	public static final ExceptionInfoCode INV_CMD_RESP_TYPE = new ExceptionInfoCode(
			M_INV_CMD_RESP_TYPE);

	public static final ExceptionInfoCode INV_CMD_TYPE = new ExceptionInfoCode(
			M_INV_CMD_TYPE);

	public static final ExceptionInfoCode INV_DESC_TYPE = new ExceptionInfoCode(
			M_INV_DESC_TYPE);

	public static final ExceptionInfoCode INV_TERM_TYPE = new ExceptionInfoCode(
			M_INV_TERM_TYPE);

	public static final ExceptionInfoCode INV_EVT_BUFFER_CTRL = new ExceptionInfoCode(
			M_INV_EVT_BUFFER_CTRL);

	public static final ExceptionInfoCode INV_MODEM_TYPE = new ExceptionInfoCode(
			M_INV_MODEM_TYPE);

	public static final ExceptionInfoCode INV_MUX_TYPE = new ExceptionInfoCode(
			M_INV_MUX_TYPE);

	public static final ExceptionInfoCode INV_SERVICE_STATE = new ExceptionInfoCode(
			M_INV_SERVICE_STATE);

	public static final ExceptionInfoCode INV_SIGNAL_PARAM_TYPE = new ExceptionInfoCode(
			M_INV_SIGNAL_PARAM_TYPE);

	public static final ExceptionInfoCode INV_SIGNAL_TYPE = new ExceptionInfoCode(
			M_INV_SIGNAL_TYPE);

	public static final ExceptionInfoCode INV_STREAM_MODE = new ExceptionInfoCode(
			M_INV_STREAM_MODE);

	public static final ExceptionInfoCode INV_TOPOLOGY_DIR = new ExceptionInfoCode(
			M_INV_TOPOLOGY_DIR);

	public static final ExceptionInfoCode INV_PARAM_VAL_TYPE = new ExceptionInfoCode(
			M_INV_PARAM_VAL_TYPE);

	public static final ExceptionInfoCode INV_PARAM_RELATION = new ExceptionInfoCode(
			M_INV_PARAM_RELATION);

	public static final ExceptionInfoCode INV_PKG_ITEM_TYPE = new ExceptionInfoCode(
			M_INV_PKG_ITEM_TYPE);

	public static final ExceptionInfoCode INV_PRIORITY_VAL = new ExceptionInfoCode(
			M_INV_PRIORITY_VAL);

	public static final ExceptionInfoCode DUPLICATE_DESC_IN_CMD = new ExceptionInfoCode(
			M_DUPLICATE_DESC_IN_CMD);

	public static final ExceptionInfoCode MISSING_DIGIT_WITH_QUALIFIER_DOT = new ExceptionInfoCode(
			M_MISSING_DIGIT_WITH_QUALIFIER_DOT);

	public static final ExceptionInfoCode SYNTAX_ERR_IN_TERM_NAME = new ExceptionInfoCode(
			M_SYNTAX_ERR_IN_TERM_NAME);

	public static final ExceptionInfoCode SYNTAX_ERR_IN_DMAP_NAME = new ExceptionInfoCode(
			M_SYNTAX_ERR_IN_DMAP_NAME);

	public static final ExceptionInfoCode SYNTAX_ERR_IN_SVC_CHNG_PROFILE = new ExceptionInfoCode(
	...
	public static final ExceptionInfoCode getObject(int value)
		...
		default:
			throw new IllegalArgumentException(
					"There is no ExceptionInfoCode for value " + value);
		}
