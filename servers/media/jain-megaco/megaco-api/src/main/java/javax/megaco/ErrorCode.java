...
public class ErrorCode implements Serializable {
	...
	public static final ErrorCode PEER_ENTITY_UNVBLE = new ErrorCode(
			M_PEER_ENTITY_UNVBLE);
	public static final ErrorCode INV_LOCAL_TPT_ADDRESS = new ErrorCode(
			M_INV_LOCAL_TPT_ADDRESS);
	public static final ErrorCode INV_REMOTE_TPT_ADDRESS = new ErrorCode(
			M_INV_REMOTE_TPT_ADDRESS);
	public static final ErrorCode INV_LCL_RMT_ADDR_PAIR = new ErrorCode(
			M_INV_LCL_RMT_ADDR_PAIR);
	public static final ErrorCode INV_ASSOC_ID = new ErrorCode(M_INV_ASSOC_ID);
	public static final ErrorCode INV_SVC_CHNG_METH_REASON_PAIR = new ErrorCode(
			M_INV_SVC_CHNG_METH_REASON_PAIR);
	public static final ErrorCode UNSPTD_ENC_FORMAT = new ErrorCode(
			M_UNSPTD_ENC_FORMAT);
	public static final ErrorCode UNSPTD_TPT_TYPE = new ErrorCode(
			M_UNSPTD_TPT_TYPE);
	public static final ErrorCode INV_SVC_CHNG_ADDR = new ErrorCode(
			M_INV_SVC_CHNG_ADDR);
	public static final ErrorCode INV_HOFF_MGCID = new ErrorCode(
			M_INV_HOFF_MGCID);
	public static final ErrorCode UNSPTD_SVC_CHNG_METH_EXTN = new ErrorCode(
			M_UNSPTD_SVC_CHNG_METH_EXTN);
	public static final ErrorCode INV_SVC_CHNG_REASON = new ErrorCode(
			M_INV_SVC_CHNG_REASON);
	public static final ErrorCode INV_SVC_CHNG_METHOD = new ErrorCode(
			M_INV_SVC_CHNG_METHOD);
	public static final ErrorCode RES_UNVBLE = new ErrorCode(M_RES_UNVBLE);
	public static final ErrorCode MODIFY_ENC_FORMAT_FAILURE = new ErrorCode(
			M_MODIFY_ENC_FORMAT_FAILURE);
	public static final ErrorCode MODIFY_TPT_TYPE_FAILURE = new ErrorCode(
			M_MODIFY_TPT_TYPE_FAILURE);
	public static final ErrorCode MODIFY_SVC_PROFILE_FAILURE = new ErrorCode(
			M_MODIFY_SVC_PROFILE_FAILURE);
	public static final ErrorCode MODIFY_PROTOCOL_VERSION_FAILURE = new ErrorCode(
			M_MODIFY_PROTOCOL_VERSION_FAILURE);
	public static final ErrorCode INV_ACTION_HANDLE = new ErrorCode(
			M_INV_ACTION_HANDLE);
	public static final ErrorCode WLDCRD_CMD_NOT_SUPTD = new ErrorCode(
			M_WLDCRD_CMD_NOT_SUPTD);
	public static final ErrorCode INV_CMD_REQID = new ErrorCode(M_INV_CMD_REQID);
	public static final ErrorCode INV_CMD_RESPID = new ErrorCode(
			M_INV_CMD_RESPID);
	public static final ErrorCode TERM_TYPE_NOT_INSYNCH = new ErrorCode(
			M_TERM_TYPE_NOT_INSYNCH);
	public static final ErrorCode INV_TERM_NAME_FORMAT = new ErrorCode(
			M_INV_TERM_NAME_FORMAT);
	public static final ErrorCode TOPOLOGY_DESC_NOT_SUPTD = new ErrorCode(
			M_TOPOLOGY_DESC_NOT_SUPTD);
	public static final ErrorCode MEDIA_DESC_NOT_SUPTD = new ErrorCode(
			M_MEDIA_DESC_NOT_SUPTD);
	public static final ErrorCode MODEM_DESC_NOT_SUPTD = new ErrorCode(
			M_MODEM_DESC_NOT_SUPTD);
	public static final ErrorCode MUX_DESC_NOT_SUPTD = new ErrorCode(
			M_MUX_DESC_NOT_SUPTD);
	public static final ErrorCode EVENT_DESC_NOT_SUPTD = new ErrorCode(
			M_EVENT_DESC_NOT_SUPTD);
	public static final ErrorCode SIGNAL_DESC_NOT_SUPTD = new ErrorCode(
			M_SIGNAL_DESC_NOT_SUPTD);
	public static final ErrorCode DIGITMAP_DESC_NOT_SUPTD = new ErrorCode(
			M_DIGITMAP_DESC_NOT_SUPTD);
	public static final ErrorCode EVENTBUFF_DESC_NOT_SUPTD = new ErrorCode(
			M_EVENTBUFF_DESC_NOT_SUPTD);
	public static final ErrorCode AUDIT_DESC_NOT_SUPTD = new ErrorCode(
			M_AUDIT_DESC_NOT_SUPTD);
	public static final ErrorCode OBSRD_EVENT_DESC_NOT_SUPTD = new ErrorCode(
			M_OBSRD_EVENT_DESC_NOT_SUPTD);
	public static final ErrorCode STATS_DESC_NOT_SUPTD = new ErrorCode(
			M_STATS_DESC_NOT_SUPTD);
	public static final ErrorCode PCKG_DESC_NOT_SUPTD = new ErrorCode(
			M_PCKG_DESC_NOT_SUPTD);
	public static final ErrorCode SDPINFO_NOT_SUPTD = new ErrorCode(
			M_SDPINFO_NOT_SUPTD);
	public static final ErrorCode INV_PKG_ITEM_TYPE = new ErrorCode(
			M_INV_PKG_ITEM_TYPE);
	public static final ErrorCode INV_CTXID_TERMTYPE_PAIR = new ErrorCode(
			M_INV_CTXID_TERMTYPE_PAIR);
	public static final ErrorCode MISSING_LCL_TPT_ADDR = new ErrorCode(
			M_MISSING_LCL_TPT_ADDR);
	public static final ErrorCode MISSING_REMOTE_TPT_ADDR = new ErrorCode(
			M_MISSING_REMOTE_TPT_ADDR);
	public static final ErrorCode MISSING_SVC_CHNG_REASON = new ErrorCode(
			M_MISSING_SVC_CHNG_REASON);
	public static final ErrorCode MISSING_SVC_CHNG_METHOD = new ErrorCode(
			M_MISSING_SVC_CHNG_METHOD);
	public static final ErrorCode MISSING_ENC_FORMAT = new ErrorCode(
			M_MISSING_ENC_FORMAT);
	public static final ErrorCode TPT_ADDR_ALREADY_INUSE = new ErrorCode(
	...
	public static final ErrorCode getObject(int value)
		...
		default:
			IllegalArgumentException illegalArgumentException = new IllegalArgumentException(
					"No ErrorCode for passed value = " + value);
