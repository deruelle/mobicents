...
public class BaseRootPkg extends MegacoPkg {
	...
	/**
	 * This method return the package Id of the MEGACO package for which the object is created. For Base ROOT Package constant value {@link BASE_ROOT_PACKAGE} shall be returned.
	 * @return Constant value {@link BASE_ROOT_PACKAGE} indicating Base ROOT Package.
	 */
