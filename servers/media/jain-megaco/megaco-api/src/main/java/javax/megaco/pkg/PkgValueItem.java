...
class PkgValueItem extends PkgItem{
	 ...
	 */
	public final java.lang.String[] getItemStringValue() throws javax.megaco.MethodInvocationException, javax.megaco.ParameterNotSetException {
		if (itemValueType != ParamValueType.M_ITEM_PARAM_VALUE_STRING) {
			throw new MethodInvocationException("Item type is not String, its: " + super.typeToString(itemValueType));
		}
	 ...
	 * {@link ParamValueType.M_ITEM_PARAM_VALUE_INTEGER}. Else shall throw an
	 * exception.
	 * 
	 ...
	 *             - Thrown if this parameter has not been set.
	 */
	public final int[] getItemIntValue() throws javax.megaco.MethodInvocationException, javax.megaco.ParameterNotSetException {
		if (itemValueType != ParamValueType.M_ITEM_PARAM_VALUE_INTEGER) {
			throw new MethodInvocationException("Item type is not integer, its: " + super.typeToString(itemValueType));
		}
	 ...
	 * {@link ParamValueType.M_ITEM_PARAM_VALUE_BOOLEAN}. Else shall throw an
	 * exception.
	 * 
	 ...
	 *             - Thrown if this parameter has not been set.
	 */
	public final boolean getItemBooleanValue() throws javax.megaco.MethodInvocationException, javax.megaco.ParameterNotSetException {
		if (itemValueType != ParamValueType.M_ITEM_PARAM_VALUE_BOOLEAN) {
			throw new MethodInvocationException("Item type is not boolean, its: " + super.typeToString(this.itemValueType));
		}
	 ...
	 * This is to be called only if the getItemValueType returns
	 * {@link ParamValueType.M_ITEM_PARAM_VALUE_DOUBLE}. Else shall throw an
	 * exception. This shall change to INT64 bit value in the next release of
	 * RFC3015.
	 * 
	 ...
	 *             - Thrown if this parameter has not been set.
	 */
	public final double[] getItemDoubleValue() throws javax.megaco.MethodInvocationException, javax.megaco.ParameterNotSetException {
		if (itemValueType != ParamValueType.M_ITEM_PARAM_VALUE_DOUBLE) {
			throw new MethodInvocationException("Item type is not double, its: " + super.typeToString(itemValueType));
		}
	 ...
	 *             value.
	 */
	public final void setItemValue(java.lang.String[] value) throws javax.megaco.InvalidArgumentException {
		if (value == null) {
			// FIXME: ??
		...
		if (itemValueType != ParamValueType.M_ITEM_PARAM_VALUE_STRING) {
			throw new InvalidArgumentException("Item type is not String, its: " + super.typeToString(itemValueType));
		}
	 ...
	 * type. This is to be called only if the getItemValueType returns
	 * {@link ParamValueType.M_ITEM_PARAM_VALUE_INTEGER}. If values is of
	 * enumerated type, the integer value should be one defined in the
	 * corresponding parameter's constants. Else shall throw an exception.
	 * 
	 * 
	 * 
	 * @param value
	 ...
	 *             value.
	 */
	public final void setItemValue(int[] value) throws javax.megaco.InvalidArgumentException {
		if (value == null) {
			// FIXME: ??
			throw new InvalidArgumentException("Value can not be null");
		}
		...
		if (itemValueType != ParamValueType.M_ITEM_PARAM_VALUE_INTEGER) {
			throw new InvalidArgumentException("Item type is not integer, its: " + super.typeToString(itemValueType));
		}
		this.intValue = value;
	}
	 ...
	 *             value.
	 */
	public final void setItemValue(boolean value) throws InvalidArgumentException {

		// FIXME: jsr jdoc has no throws
		if (itemValueType != ParamValueType.M_ITEM_PARAM_VALUE_BOOLEAN) {
			throw new InvalidArgumentException("Item type is not boolean, its: " + super.typeToString(itemValueType));
		}
	 ...
	 *             value.
	 */
	public final void setItemValue(double[] value) throws javax.megaco.InvalidArgumentException {
		if (value == null) {
			// FIXME: ??
			throw new InvalidArgumentException("Value can not be null");
		}
		...
		if (itemValueType != ParamValueType.M_ITEM_PARAM_VALUE_DOUBLE) {
			throw new InvalidArgumentException("Item type is not double, its: " + super.typeToString(itemValueType));
		}
