...
public class DeleteAssocResp extends AssociationEvent {

	protected ReturnStatus eventStatus = null;
	protected ErrorCode errorCode = null;

	public DeleteAssocResp(Object source, int assocHandle) throws IllegalArgumentException {
	...
	public final int getAssocOperIdentifier() {
		return AssocEventType.M_DELETE_ASSOC_RESP;
	}
	 ...
	 * 
	 * @param errorCode
	 *            - The error code correspondingto why the delete association
	 *            event could not be executed successfuly.
	 * @throws IllegalArgumentException
	 ...
	 *             2. If the error code is not valid for the DeleteAssocReq
	 *             class.
	 */
