...
/**
 * The MEGACO NormMGExecTime property class extends the PkgPrptyItem class. This
 * is a final class. This class defines NormMGExecTime property of MEGACO Root
...
public final class RootNormMGExecTimePrpt extends PkgPrptyItem {
	 ...
	 */
	public static final int ROOT_NORM_MG_EXEC_TIME_PRPT = 0x0003;
	 ...
	 */
	public RootNormMGExecTimePrpt() {
		super();
		super.propertyId = ROOT_NORM_MG_EXEC_TIME_PRPT;
		super.itemId = ROOT_NORM_MG_EXEC_TIME_PRPT;
	 ...
	 * 
	 * @return It shall return {@link ROOT_NORM_MG_EXEC_TIME_PRPT}
	 */
