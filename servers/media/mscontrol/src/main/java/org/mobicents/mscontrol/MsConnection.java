...
public interface MsConnection extends Serializable {
     ...
     * MsConnection object despite the state of the MsConnection object. 
     * This MsSession reference does not change once the MsConnection object 
     * has been created. 
     *
     ...
     *
     * @return the name of the endpoint on the media server or null if connection
     * is not created on media server yet.
     */
     ...
     *
     * @param listener the listener object was added previously.
     */
     ...
     *
     * @param remoteDesc the session desriptor of the remote party.
     */
