...
public class DescriptorType implements Serializable {
	...
	public static final DescriptorType EVENT_DESC = new DescriptorType(
			M_EVENT_DESC);
	public static final DescriptorType DIGIT_MAP_DESC = new DescriptorType(
			M_DIGIT_MAP_DESC);

	public static final DescriptorType SIGNAL_DESC = new DescriptorType(
			M_SIGNAL_DESC);

	public static final DescriptorType MEDIA_DESC = new DescriptorType(
			M_MEDIA_DESC);

	public static final DescriptorType STREAM_DESC = new DescriptorType(
			M_STREAM_DESC);

	public static final DescriptorType LOCAL_CONTROL_DESC = new DescriptorType(
			M_LOCAL_CONTROL_DESC);

	public static final DescriptorType TERMINATION_STATE_DESC = new DescriptorType(
			M_TERMINATION_STATE_DESC);

	public static final DescriptorType SERVICE_CHANGE_DESC = new DescriptorType(
			M_SERVICE_CHANGE_DESC);

	public static final DescriptorType SERVICE_CHANGE_RESP_DESC = new DescriptorType(
			M_SERVICE_CHANGE_RESP_DESC);

	public static final DescriptorType AUDIT_CAP_DESC = new DescriptorType(
			M_AUDIT_CAP_DESC);

	public static final DescriptorType AUDIT_VAL_DESC = new DescriptorType(
			M_AUDIT_VAL_DESC);

	public static final DescriptorType AUDIT_CAP_REPLY_DESC = new DescriptorType(
			M_AUDIT_CAP_REPLY_DESC);

	public static final DescriptorType AUDIT_VAL_REPLY_DESC = new DescriptorType(
			M_AUDIT_VAL_REPLY_DESC);

	public static final DescriptorType EVENT_BUF_DESC = new DescriptorType(
			M_EVENT_BUF_DESC);

	public static final DescriptorType STATISTICS_DESC = new DescriptorType(
			M_STATISTICS_DESC);

	public static final DescriptorType PACKAGE_DESC = new DescriptorType(
			M_PACKAGE_DESC);

	public static final DescriptorType ERROR_DESC = new DescriptorType(
			M_ERROR_DESC);

	public static final DescriptorType MODEM_DESC = new DescriptorType(
			M_MODEM_DESC);

	public static final DescriptorType MUX_DESC = new DescriptorType(M_MUX_DESC);

	public static final DescriptorType TOPOLOGY_DESC = new DescriptorType(
			M_TOPOLOGY_DESC);

	public static final DescriptorType CTX_TERM_AUDIT_DESC = new DescriptorType(
			M_CTX_TERM_AUDIT_DESC);

	public static final DescriptorType OBSERVED_EVENT_DESC = new DescriptorType(
	 ...
	 */
	public static DescriptorType getObject(int value)
		...
		default:
			throw new IllegalArgumentException(
					"There is no DescriptorType defined for value " + value);
		}
		return d;
	}
