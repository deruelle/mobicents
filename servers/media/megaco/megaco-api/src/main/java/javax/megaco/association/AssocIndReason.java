...
public class AssocIndReason implements Serializable {
	 ...
	 */
	public static final AssocIndReason IND_RCVD_FRM_PEER = new AssocIndReason(
			M_IND_RCVD_FRM_PEER);
	/**
	 * Identifies a AssocIndReason object that constructs the class with the
	 * field constant M_RETRIES_XPIRED.
	 */
	public static final AssocIndReason RETRIES_XPIRED = new AssocIndReason(
			M_RETRIES_XPIRED);
	/**
	 * Identifies a AssocIndReason object that constructs the class with the
	 * field constant M_TIMER_EXP_IND.
	 */
	public static final AssocIndReason TIMER_EXP_IND = new AssocIndReason(
			M_TIMER_EXP_IND);
	/**
	 * Identifies a AssocIndReason object that constructs the class with the
	 * field constant M_OPER_COMPL_IND.
	 */
	public static final AssocIndReason OPER_COMPL_IND = new AssocIndReason(
			M_OPER_COMPL_IND);
	/**
	 * Identifies a AssocIndReason object that constructs the class with the
	 * field constant M_NW_FAILURE_IND.
	 */
	public static final AssocIndReason NW_FAILURE_IND = new AssocIndReason(
			M_NW_FAILURE_IND);
	/**
	 * Identifies a AssocIndReason object that constructs the class with the
	 * field constant M_NW_LINKUP_IND.
	 */
	public static final AssocIndReason NW_LINKUP_IND = new AssocIndReason(
			M_NW_LINKUP_IND);
	...
	public static final AssocIndReason getObject(int value)
		...
		default:
			throw new IllegalArgumentException(
					"Wrogn value passed, there is no AssocIndReason with code: "
							+ value);
		}
	}
