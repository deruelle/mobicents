...
public class CmdResponseType implements Serializable {
	...
	public static final CmdResponseType ADD_RESP = new CmdResponseType(
			M_ADD_RESP);
	public static final CmdResponseType MODIFY_RESP = new CmdResponseType(
			M_MODIFY_RESP);
	public static final CmdResponseType MOVE_RESP = new CmdResponseType(
			M_MOVE_RESP);
	public static final CmdResponseType SERVICE_CHANGE_RESP = new CmdResponseType(
			M_SERVICE_CHANGE_RESP);
	public static final CmdResponseType NOTIFY_RESP = new CmdResponseType(
			M_NOTIFY_RESP);
	public static final CmdResponseType AUDIT_VAL_RESP = new CmdResponseType(
			M_AUDIT_VAL_RESP);
	public static final CmdResponseType AUDIT_CAP_RESP = new CmdResponseType(
			M_AUDIT_CAP_RESP);
	public static final CmdResponseType SUBTRACT_RESP = new CmdResponseType(
			M_SUBTRACT_RESP);
	...
	public static final CmdResponseType getObject(int value)
		...
		default:
			IllegalArgumentException illegalArgumentException = new IllegalArgumentException(
					"No CmdResponseType found for value = " + value);
