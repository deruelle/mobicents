...
public class RTPAudioFormat extends AudioFormat {
    ...
    public static RTPAudioFormat parseFormat(String rtpmap) {
        ...
        int bits = getBits(encodingName);
        
        if (encodingName.equals("telephone-event")) {
            return new RTPAudioFormat(p, encodingName);
        } else if (encodingName.equals("pcmu")) {
    ...
    public String toString() {
        String encName = getEncoding().toLowerCase();
        if (encName.equals("telephone-event")) {
            return payload + " telephone-event/8000";
        } else {
