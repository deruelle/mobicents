 ...
 * 
 */
public class MediaResourceAdaptor implements ResourceAdaptor, MsConnectionListener,
        MsResourceListener, MsLinkListener, MsSessionListener, MsNotificationListener {
    ...
    // events
    private transient EventLookupFacility eventLookup = null;    // The list of activites stored in this resource adaptor is managed by
    // MediaActivityManager.
    // MediaActivityManager mediaActivityManager = new MediaActivityManager();    // The activity context interface factory defined in
    ...
    public void entityActivated() throws ResourceException {
        try {
            ...
            msProvider.addNotificationListener(this);
