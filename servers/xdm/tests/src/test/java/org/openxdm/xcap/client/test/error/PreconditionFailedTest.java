...
public class PreconditionFailedTest {
	...
	public void test() throws HttpException, IOException, JAXBException, InterruptedException {
		...
		Response response = client.putDocument(documentKey,appUsage.getMimetype(),documentContent);		
		// check put response
		...
		// send put request and get response
		response = client.putDocumentIfMatch(documentKey,eTag+"z",appUsage.getMimetype(),documentContent);		
		// check put response
		assertTrue("Put response must exists",response != null);
		...
		// send put request and get response
		response = client.putDocumentIfNoneMatch(documentKey,eTag,appUsage.getMimetype(),documentContent);		
		// check put response
		assertTrue("Put response must exists",response != null);
		assertTrue("Put response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		response = client.deleteDocumentIfMatch(documentKey,eTag+"z");		
		...
		// send delete request and get response
		response = client.deleteDocumentIfNoneMatch(documentKey,eTag);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send put request and get response
		response = client.putElementIfMatch(elementKey,eTag+"z",elementContent);				
		// check put response
		assertTrue("Put response must exists",response != null);
		assertTrue("Put response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send put request and get response
		response = client.putElementIfNoneMatch(elementKey,eTag,elementContent);				
		// check put response
		assertTrue("Put response must exists",response != null);
		assertTrue("Put response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send put request and get response
		response = client.putElement(elementKey,elementContent);				
		// check put response
		assertTrue("Put response must exists",response != null);
		assertTrue("Put response code should be 201",response.getCode() == 201);
		...
		// send delete request and get response
		response = client.deleteElementIfMatch(elementKey,eTag+"z");		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send delete request and get response
		response = client.deleteElementIfNoneMatch(elementKey,eTag);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send put request and get response
		response = client.putAttributeIfMatch(attrKey,eTag+"z",attrContent);				
		// check put response
		assertTrue("Put response must exists",response != null);
		assertTrue("Put response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send put request and get response
		response = client.putAttributeIfNoneMatch(attrKey,eTag,attrContent);				
		// check put response
		assertTrue("Put response must exists",response != null);
		assertTrue("Put response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send put request and get response
		response = client.putAttribute(attrKey,attrContent);				
		// check put response
		assertTrue("Put response must exists",response != null);
		...
		// send delete request and get response
		response = client.deleteAttributeIfMatch(attrKey,eTag+"z");		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send delete request and get response
		response = client.deleteAttributeIfNoneMatch(attrKey,eTag);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
