...
public class NotFoundTest {
	...
	public void test() throws HttpException, IOException, JAXBException, InterruptedException {
		...
		response = client.deleteDocument(fakeAppUsageDocumentKey);		
		...
		// send delete request and get response
		response = client.deleteElement(fakeAppUsageElementKey);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send delete request and get response
		response = client.deleteAttribute(fakeAppUsageAttrWithElementKey);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send delete request and get response
		response = client.deleteDocument(documentKey);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send delete request and get response
		response = client.deleteElement(elementKey);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send delete request and get response
		response = client.deleteAttribute(attrWithElementKey);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		response = client.putDocument(documentKey,appUsage.getMimetype(),documentContent);		
		// check put response
		...
		// send delete request and get response
		response = client.deleteElement(elementParentKey);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send delete request and get response
		response = client.deleteAttribute(attrWithoutElementKey);		
		// check delete response
		assertTrue("Delete response must exists",response != null);
		assertTrue("Delete response code should be "+exception.getResponseStatus(),response.getCode() == exception.getResponseStatus());
		...
		// send put request and get response
		response = client.putElement(elementParentKey,elementContent);				
		// check put response
		assertTrue("Put response must exists",response != null);
		assertTrue("Put response code should be 201",response.getCode() == 201);
