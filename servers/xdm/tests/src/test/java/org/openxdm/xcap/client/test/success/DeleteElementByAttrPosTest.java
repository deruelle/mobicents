...
public class DeleteElementByAttrPosTest {
	
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(DeleteElementByAttrPosTest.class);
	}
	...
	public void test() throws HttpException, IOException, JAXBException, InterruptedException {
		...
		Response elemDeleteResponse = client.deleteElement(elemKey);
