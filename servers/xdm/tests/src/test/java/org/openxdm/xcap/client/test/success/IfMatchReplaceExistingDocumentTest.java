...
public class IfMatchReplaceExistingDocumentTest {
	
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(IfMatchReplaceExistingDocumentTest.class);
	}
	...
	public void test() throws HttpException, IOException, JAXBException, InterruptedException {
		...
		Response initialPutResponse = client.putDocument(key,appUsage.getMimetype(),newContent);
		...
		// send put request and get response
		Response replacePutResponse = client.putDocumentIfMatch(key,initialGetResponse.getETag(),appUsage.getMimetype(),replaceContent);
