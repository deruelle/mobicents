...
public class BadRequestTest {
	...
	public void test() throws HttpException, IOException, JAXBException, InterruptedException {
		...
		Response response = client.putDocument(key,appUsage.getMimetype(),content);
		...
		// send put request and get response
		Response putResponse = client.putAttribute(attrKey,"friends");
		...
		Response deleteResponse = client.deleteAttribute(anotherAttrKey);
		// check put response, must be bad request
