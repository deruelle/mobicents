...
public class UnsupportedMediaTypeTest {
	...
	public void test() throws HttpException, IOException, JAXBException, InterruptedException {
		...
		Response response = client.putDocument(documentKey,"badmimetype",documentContent);
		...
		// send put request and get response		
		response = client.putDocument(evilKey,"badmimetype",elementContent);
		...
		// send put request and get response
		response = client.putDocument(anotherEvilKey,"badmimetype","friends");
		...
		// send put request and get response
		response = client.putDocument(documentKey,"badmimetype",documentContent);
		...
		// send put request and get response
		response = client.putAttribute(attributeKey,"friends");
