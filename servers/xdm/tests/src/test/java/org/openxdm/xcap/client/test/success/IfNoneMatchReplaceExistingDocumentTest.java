...
public class IfNoneMatchReplaceExistingDocumentTest {
	...
	public void test() throws HttpException, IOException, JAXBException, InterruptedException {
		...
		// send put request and get response
		Response replacePutResponse = client.putDocumentIfNoneMatch(key,"1",appUsage.getMimetype(),replaceContent);
