...
public class NotWellFormedTest {
	...
	public void test() throws HttpException, IOException, JAXBException, InterruptedException {
		...
		Response response = client.putDocument(key,appUsage.getMimetype(),badDocumentContent);
		...
		// send put request and get response
		response = client.putDocument(key,appUsage.getMimetype(),goodDocumentContent);
		...
		// send put request and get response
		response = client.putDocument(key,appUsage.getMimetype(),badDocumentContent);
