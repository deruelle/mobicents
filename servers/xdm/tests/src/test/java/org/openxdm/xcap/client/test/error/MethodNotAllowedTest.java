...
public void test() throws HttpException, IOException, JAXBException, InterruptedException {
		...
		Response putResponse = client.putDocument(key,appUsage.getMimetype(),content);
		...
		// send put request and get response
		Response nsPutResponse = client.putDocument(nsKey,appUsage.getMimetype(),content);
		...
		Response nsDeleteResponse = client.deleteDocument(nsKey);
