...
public abstract class AbstractAppUsageSbb implements javax.slee.Sbb {
	...
	public void onServiceStartedEvent(
		...
		if (isLogDebugEnabled()) logAsDebug("onServiceStartedEvent(event=" + event.toString() + ",aci="
				+ aci.toString() + ")");
		try {
			...
			if (sa.equals(aci.getActivity())) {
				if (isLogDebugEnabled()) logAsDebug("Service activated...");
	...
	public void onActivityEndEvent(ActivityEndEvent event,
		...
		logAsInfo("onActivityEndEvent(event=" + event.toString() + ",aci="
				+ aci.toString() + ")");

		if (!(aci.getActivity() instanceof HttpSessionActivity)) {
			// not an activity from http ra, must be the service activity then
	...
	public void onDelete(HttpServletRequestEvent event,
		...
		logAsInfo("onDelete(event=" + event.toString() + ",aci="
				+ aci.toString() + ")");
	...
	public void onGet(HttpServletRequestEvent event,
		...
		logAsInfo("onGet(event=" + event.toString() + ",aci=" + aci.toString()
				+ ")");
	...
	public void onPut(HttpServletRequestEvent event,
		...
		logAsInfo("onPut(event=" + event.toString() + ",aci=" + aci.toString()
				+ ")");
	...
	public void onPost(HttpServletRequestEvent event,
		...
		logAsInfo("onPost(event=" + event.toString() + ",aci=" + aci.toString()
				+ ")");
	...
	public void onHead(HttpServletRequestEvent event,
		...
		logAsInfo("onHead(event=" + event.toString() + ",aci=" + aci.toString()
				+ ")");
	...
	public void onOptions(HttpServletRequestEvent event,
		...
		logAsInfo("onOptions(event=" + event.toString() + ",aci="
				+ aci.toString() + ")");
	...
	public void onTrace(HttpServletRequestEvent event,
		...
		logAsInfo("onTrace(event=" + event.toString() + ",aci="
				+ aci.toString() + ")");
