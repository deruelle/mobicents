 ...
 * generated in the org.openxdm.xcap.client.error package. 
...
public class ObjectFactory {
    ...
    private final static QName _Extension_QNAME = new QName("urn:ietf:params:xml:ns:xcap-error", "extension");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.openxdm.xcap.client.error
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:ietf:params:xml:ns:xcap-error", name = "extension", substitutionHeadNamespace = "urn:ietf:params:xml:ns:xcap-error", substitutionHeadName = "error-element")
