...
public class CodecLocator {
    private final static AudioFormat linearAudio = new AudioFormat(
            AudioFormat.LINEAR, 8000, 16, 1,
            AudioFormat.LITTLE_ENDIAN,
            AudioFormat.SIGNED);
    private final static AudioFormat pcma = new AudioFormat(
            AudioFormat.ALAW, 8000, 8, 1);    
    private final static AudioFormat pcmu = new AudioFormat(
