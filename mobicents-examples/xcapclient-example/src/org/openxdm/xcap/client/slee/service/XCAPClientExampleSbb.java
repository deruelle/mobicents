...
import org.openxdm.xcap.common.appusage.ResourceListsAppUsage;
...
public abstract class XCAPClientExampleSbb implements javax.slee.Sbb {
	...
	public void syncTest() throws HttpException, IOException, JAXBException {
		...
		// create uri		
		UserDocumentUriKey docKey = new UserDocumentUriKey(ResourceListsAppUsage.ID,userName,documentName);
		...
		Response response = ra.putDocument(docKey,ResourceListsAppUsage.MIMETYPE,initialDocument);
		...
		UserElementUriKey elemKey = new UserElementUriKey(ResourceListsAppUsage.ID,userName,documentName,new ElementSelector(elementSelectorSteps),null);		
	...
	public void asyncTest() throws ActivityAlreadyExistsException, CouldNotStartActivityException, NullPointerException, UnrecognizedActivityException, TransactionRequiredLocalException, TransactionRolledbackLocalException, HttpException, SLEEException, IllegalStateException, JAXBException, IOException {
		...
		elementSelectorSteps.add(step1);
		elementSelectorSteps.addLast(step2);
		ResourceListsUserElementUriKey key = new ResourceListsUserElementUriKey(ResourceListsAppUsage.ID,userName,documentName,new ElementSelector(elementSelectorSteps),null);		
