...
public abstract class CommonSbb implements Sbb {
	...
	protected final void trace(Level level, String message) {
		try {
			traceFacility.createTrace(sbbId, level, "BounceSbb", message,
					System.currentTimeMillis());
		} catch (Exception e) {
		}
		System.out.println("BounceSbb [" + System.currentTimeMillis() + "]: "
				+ message);
	}

	protected final void trace(Level level, String message, Throwable t) {
		try {
			traceFacility.createTrace(sbbId, level, "BounceSbb", message, t,
					System.currentTimeMillis());
		} catch (Exception e) {
		}
		System.out.println("BounceSbb [" + System.currentTimeMillis() + "]: "
