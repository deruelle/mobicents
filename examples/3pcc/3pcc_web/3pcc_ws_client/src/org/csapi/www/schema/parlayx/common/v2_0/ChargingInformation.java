...
public class ChargingInformation  implements java.io.Serializable {
    ...
    private static org.jboss.axis.description.TypeDesc typeDesc =
        new org.jboss.axis.description.TypeDesc(ChargingInformation.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.csapi.org/schema/parlayx/common/v2_0", "ChargingInformation"));
