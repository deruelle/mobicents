...
public class PolicyException  extends org.jboss.axis.AxisFault  implements java.io.Serializable {
    ...
    private static org.jboss.axis.description.TypeDesc typeDesc =
        new org.jboss.axis.description.TypeDesc(PolicyException.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://v2_0.common.parlayx.schema.www.csapi.org", "PolicyException"));
