...
public class RAFrameResourceAdaptor implements RAFStackListener, ResourceAdaptor, Serializable {
     ...
     * <br>
     * The SLEE calls this method to inform the resource adaptor object that the specified event was processed
     * unsuccessfully by the SLEE. Event processing can fail if, for example, the SLEE doesn’t have enough resource
     ...
     * Please refer to JSLEE v1.1 Specification, Early Draft Review Page 301 for further information.
     * <br>
     * The SLEE calls this method to inform the resource adaptor that the activity’s Activity Context object is no
