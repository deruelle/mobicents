...
public class RemoveProfileTask implements SubTask {
    ...
    private static Logger logger = Logger.getLogger(org.mobicents.ant.tasks.RemoveProfileTask.class.getName());

    public void run(SleeCommandInterface slee) {
		// TODO Auto-generated method stub
    	try {
    		// Invoke the operation
			Object result = slee.invokeOperation("-removeProfile", profileTableName, profileName, null);
