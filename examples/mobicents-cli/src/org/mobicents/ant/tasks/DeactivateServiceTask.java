...
public class DeactivateServiceTask implements SubTask {
    ...
    private static Logger logger = Logger.getLogger(org.mobicents.ant.tasks.DeactivateServiceTask.class.getName());
    ...
    public void run(SleeCommandInterface slee) {
    	...
    	try {
			...
			Object result = slee.invokeOperation("-deactivateService", service.toString(), null, null);
