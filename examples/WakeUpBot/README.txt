This example shows:
* how to use jsf components and SLEE communication
* usage of xmppra and slee facilities
Running the Example:
...
lib/xmppra -> ant ra-deploy  = will deploy xmpp ra - it pics up jboss bind address.
...
ACCESS:
http://jnpHostIp:8080/WakeUpBotPage
Also see:
http://wiki.java.net/bin/view/Communications/MobicentsExampleGooglePortlet
