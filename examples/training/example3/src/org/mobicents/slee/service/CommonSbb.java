...
public abstract class CommonSbb implements Sbb {
	...
	public void unsetSbbContext() {
		logger.info("BounceSBB: " + this + ": unsetSbbContext() called.");
	}
	...
	public void sbbCreate() throws javax.slee.CreateException {
		logger.info( "BounceSBB: " + this + ": sbbCreate() called.");
	}
	...
	public void sbbPostCreate() throws CreateException {
		logger.info("BounceSBB: " + this + ": sbbPostCreate() called.");
	}
	...
	public void sbbActivate() {
		logger.info( "BounceSBB: " + this + ": sbbActivate() called.");
	}
	...
	public void sbbPassivate() {
		logger.info( "BounceSBB: " + this + ": sbbPassivate() called.");
	}
	...
	public void sbbRemove() {
		logger.info("BounceSBB: " + this + ": sbbRemove() called.");
	}
	 ...
	 */
	public void sbbLoad() {
		logger.info("BounceSBB: " + this + ": sbbLoad() called.");
	}
	...
	public void sbbStore() {
		logger.info( "BounceSBB: " + this + ": sbbStore() called.");
	}
	...
	public void sbbRolledBack(javax.slee.RolledBackContext rolledBackContext) {
		logger.info( "BounceSBB: " + this + ": sbbRolledBack() called.");
	}
