This example implements a simple SIP/Media IVR example - message recording and dtmf decoding
...
?
Also see:
http://groups.google.com/group/mobicents-public/web/mobicents-media-ra
