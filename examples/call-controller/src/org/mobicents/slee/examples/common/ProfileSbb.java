 ...
 *                                                 *
 ***************************************************/
package org.mobicents.slee.examples.common;
...
public abstract class ProfileSbb implements Sbb {
	Logger logger = Logger.getLogger(org.mobicents.slee.examples.common.ProfileSbb.class.getName());
     ...
     * @return ControllerProfileCMP: The SBB uses the returned Profile CMP object
     * to access the attributes of the Profile identified by the profileID.
     */
    protected ControllerProfileCMP lookup(Address address) {
    	
		String profileTableName = new String();
    	ProfileID profileID = null;
    	ControllerProfileCMP profile = null;
    	...
    	try {
    		...
    		if (profileID != null) {
    			profile = getControllerProfileCMP(profileID);	
    		}
    		
        }catch (NullPointerException  e) {
        	logger.log(Level.WARNING, "Exception using the getProfileByIndexedAttribute method", e);
        }catch (UnrecognizedProfileTableNameException e) {
        	logger.log(Level.WARNING, "Exception in getting the Profile Specification in getControllerProfileCMP(profileID):" +
