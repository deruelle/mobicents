...
:DEACTIVATE
echo "Deactivating Back-to-Back User Agent Service"
call %JBOSS_HOME%\bin\SleeCommandInterface.bat -deactivateService "ServiceID[Back-to-Back_User_Agent_Service#PTIn#0.1]"

:INITIALIZE
set DUPATH=
set DEPID=
echo "UnDeploying Back-to-Back User Agent Service"

:CONVERT_PATH
call java -cp . PathNotationConverter "%DIRNAME%\B2BUserAgent-DU.jar" > ANSWER.DAT
