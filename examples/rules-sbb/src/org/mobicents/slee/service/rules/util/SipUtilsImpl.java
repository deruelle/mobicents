...
package org.mobicents.slee.service.rules.util;
...
import org.mobicents.slee.service.rules.app.AppSbb;

public class SipUtilsImpl implements SipUtils {

	private static Logger log = Logger.getLogger(AppSbb.class);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#generateTag()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#convertURIToAddress(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#convertURIToSipURI(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#parseSipUri(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#convertAddressToSipURI(javax.sip.address.Address)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#sendCancel(javax.sip.ClientTransaction)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#buildInvite(javax.sip.address.Address,
	 *      javax.sip.address.Address, byte[], int)
	 */
	public Request buildInvite(Address fromAddress, Address toAddress,
			byte[] content, int cSeq, CallIdHeader callIdHeader)
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#createLocalContactHeader()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#createLocalViaHeader()
	 */
	 ...
	 * 
	 * 
	 * @see se.jayway.sip.util.SipUtils#buildRequestWithAuthorizationHeader(javax.sip.ResponseEvent,
	 *      java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#buildAck(javax.sip.Dialog,
	 *      java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see se.jayway.sip.util.SipUtils#sendOk(javax.sip.message.Request)
	 */
