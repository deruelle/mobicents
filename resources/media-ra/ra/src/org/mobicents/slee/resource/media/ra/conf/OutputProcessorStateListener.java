...
public class OutputProcessorStateListener implements ControllerListener {
    ...
    public OutputProcessorStateListener(ConfParty confParty) {
    ...
    public void controllerUpdate(ControllerEvent evt) {
        ...
        if (evt instanceof javax.media.ConfigureCompleteEvent) {
            logger.debug("(party id = " + confParty.getId() + ") Realizing sender processor");
            confParty.realize(confParty.outputDsp, null);
        } else if (evt instanceof javax.media.RealizeCompleteEvent) {
            logger.debug("(party id = " + confParty.getId() + ") Starting sending stream processor");
            confParty.startSendStream();
