 ...
 */
public class DeleteConnectionHandle extends TransactionHandle {
    ...
    public DeleteConnectionHandle(JainMgcpStackImpl stack) {
        super(stack);
    }
    
    public DeleteConnectionHandle(JainMgcpStackImpl stack, InetAddress address, int port) {
