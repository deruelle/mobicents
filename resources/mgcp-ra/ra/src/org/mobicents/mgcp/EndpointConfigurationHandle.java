 ...
 */
public class EndpointConfigurationHandle extends TransactionHandle {
    
    private EndpointConfiguration command;
    private EndpointConfigurationResponse response;
    
    private Logger logger = Logger.getLogger(CreateConnectionHandle.class);
    
    /** Creates a new instance of EndpointConfigurationHandle */
    public EndpointConfigurationHandle(JainMgcpStackImpl stack) {
        super(stack);
    }

    public EndpointConfigurationHandle(JainMgcpStackImpl stack, InetAddress address, int port) {
