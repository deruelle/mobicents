 ...
 */
public class ModifyConnectionHandle extends TransactionHandle {
    ...
    public ModifyConnectionHandle(JainMgcpStackImpl stack) {
        super(stack);
    }
    
    public ModifyConnectionHandle(JainMgcpStackImpl stack, InetAddress address, int port) {
