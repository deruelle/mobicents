 ...
 */
public class CreateConnectionHandle extends TransactionHandle {
    ...
    public CreateConnectionHandle(JainMgcpStackImpl stack) {
        super(stack);
    }
    
    public CreateConnectionHandle(JainMgcpStackImpl stack, InetAddress address, int port) {
