...
public class DialogSetupConfirmedTimedOutTest extends AbstractSleeTCKTest  implements SipListener{
	//protected static Logger logger=Logger.getLogger(SipResourceAdaptor.class);
	protected static Logger logger=Logger.getLogger(DialogSetupConfirmedTimedOutTest.class);
	protected static SIPStackBinder binder=SIPStackBinder.getInstance();

	private javax.sip.Dialog localDialog=null;
	private static boolean raSETUP=false;
	private static SipRaCreator creator=null;
	public DialogSetupConfirmedTimedOutTest()
	{
		super();
		if(raSETUP)
			return;
