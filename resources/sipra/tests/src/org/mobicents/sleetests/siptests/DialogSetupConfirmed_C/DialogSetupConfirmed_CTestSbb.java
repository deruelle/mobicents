package org.mobicents.sleetests.siptests.DialogSetupConfirmed_C;
...
public abstract class DialogSetupConfirmed_CTestSbb extends BaseTCKSbb {
	 ...
	 */
	protected static Logger logger = Logger.getLogger(DialogSetupConfirmed_CTestSbb.class);
	...
	public void onDialogSetupConfirmed(javax.sip.ResponseEvent event,
		...
		logger
				.info("=================  GOT DIALOG SetupConfirmed EVENT =================== \n"
						+ event + "\n==================");
		try {
			setResultPassed("GOT SETUP SetupConfirmed!!!");
		} catch (Exception e) {
			TCKSbbUtils.handleException(e);
			e.printStackTrace();
		}
	...
	public InitialEventSelector chooseThis(InitialEventSelector ies) {
		...
		if(name.equals("DialogSetupConfirmed_CTestSbb"))
		{
