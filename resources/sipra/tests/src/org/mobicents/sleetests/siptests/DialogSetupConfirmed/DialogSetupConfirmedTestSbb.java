...
public abstract class DialogSetupConfirmedTestSbb extends BaseTCKSbb {
	 ...
	 */
	protected static Logger logger = Logger.getLogger(DialogSetupConfirmedTestSbb.class);
	...
	public InitialEventSelector chooseThis(InitialEventSelector ies) {
		...
		if(name.equals("DialogSetupConfirmedTest"))
		{
