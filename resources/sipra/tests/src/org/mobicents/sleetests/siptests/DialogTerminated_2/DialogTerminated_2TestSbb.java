package org.mobicents.sleetests.siptests.DialogTerminated_2;
...
public abstract class DialogTerminated_2TestSbb extends BaseTCKSbb {
	...
	protected static boolean setupFailedReceived = false;
	protected static boolean invitePorcessed=false;
	...
	protected static Logger logger = Logger
			.getLogger(DialogTerminated_2TestSbb.class);
	...
	public void onDialogSetupFailed(javax.sip.ResponseEvent event,
		...
		logger
				.info("=================  GOT DIALOG SetupFailed EVENT =================== \n"
						+ event + "\n==================");
		setupFailedReceived = true;
	...
	public void onDialogTerminated(javax.sip.DialogTerminatedEvent event,
		...
		logger
				.info("=================  GOT DIALOG TERMINATED EVENT =================== \n"
						+ event + "\n==================");
		try {
			if (setupFailedReceived&&setupEarlyReceived) {
				setResultPassed(" == RECEIVED SetupEarly-SetupFailed and Terminated events in order ==");
			} else {
				setResultFailed(" == RECEIVED SetupEarly("+setupEarlyReceived+")-SetupFailed("+setupFailedReceived+") and Terminated(true) events in order ==");
			}
		} catch (Exception e) {
			TCKSbbUtils.handleException(e);
			e.printStackTrace();
	...
	public InitialEventSelector chooseThis(InitialEventSelector ies) {
		...
		if(name.equals("DialogTerminated_2Test"))
		{
