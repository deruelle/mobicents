...
public class RegistrationBinding implements Serializable {
    ...
    private static Logger logger = Logger.getLogger(RegistrationBinding.class.getName());
    
    public RegistrationBinding(String contactAddress, String comment, long expiresDelta, float q, String id, long seq) {
