...
public class ProxyConfigurator implements ProxyConfiguratorMBean,Cloneable {
	...
	public Object clone()
	{
		...
		proxy.setSipRegistrationMaxExpires(this.getSipRegistrationMaxExpires());
		proxy.setSipRegistrationMinExpires(this.getSipRegistrationMinExpires());
