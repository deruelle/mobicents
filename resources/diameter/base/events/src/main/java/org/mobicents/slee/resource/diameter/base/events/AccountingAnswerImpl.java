...
/**
 * Implementation of Accounting-Answer Diameter Message. 
 * 
 * <br>Super project:  mobicents
 * <br>3:01:12 PM May 21, 2008 
 * <br>
...
public class AccountingAnswerImpl extends ExtensionDiameterMessageImpl implements AccountingAnswer
{
  ...
  public boolean hasAccountingSessionId() {
    return message.getAvps().getAvp(Avp.ACC_SESSION_ID) != null;
  }

  public byte[] getAccountingSessionId() {
    try
    {
      return message.getAvps().getAvp(Avp.ACC_SESSION_ID).getRaw();
    }
  ...
  public void setAccountingSessionId(byte[] accountingSessionId) {
    message.getAvps().addAvp(Avp.ACC_SESSION_ID, accountingSessionId);
  }
