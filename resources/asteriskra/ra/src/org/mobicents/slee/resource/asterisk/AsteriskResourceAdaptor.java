 ...
 * 
 */
public class AsteriskResourceAdaptor implements ManagerEventHandler, ResourceAdaptor,
		Serializable {
    ...
    private String MAGILogin = "manager";
    private String MAGIPassword = "secret";
    ...
    public void handleEvent(ManagerEvent event)
    {
        ...
        if (event.getClass().getName().equals("net.sf.asterisk.manager.event.ConnectEvent")){
    ...
    public void processEvent(Object event){
        ...
        if (key == null) {
        	key = new ComponentKey( event.getClass().getName(), "net.sf.asterisk", "1.0");
        ...
        activities.put(new AsteriskActivityHandle(actobj.MessageID()), actobj);
