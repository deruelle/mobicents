 ...
 * parameter, it is also suppressed.
 * <p>
...
public class UsageThresholdFilter implements NotificationFilter {
    /**
     * Create a <code>UsageThresholdFilter</code>.
    ...
    public boolean isNotificationEnabled(Notification notification) {
        ...
        if (!usageNotification.getService().equals(service)) return false;
        if (!usageNotification.getSbb().equals(sbb)) return false;
