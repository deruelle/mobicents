...
public interface SbbLocalObject {
     ...
     * @throws TransactionRequiredLocalException if this method is invoked without a valid transaction
     *        context.
     * @throws NoSuchObjectLocalException if the SBB enitty referenced by this SbbLocalObject
     *        is no longer valid.
     * @throws NoSuchObjectLocalException if <code>sbb</code> does not reference
     *        a valid SBB entity.
