...
/**
 * The <code>ProfileID</code> class defines an indentifer that can be used to
...
public class ProfileID implements Serializable {
    ...
    /**
     * Get a hash code value for this profile identifer.  The hash code is the logical
     ...
     * @return a string representation for this profile identifer.
     */
