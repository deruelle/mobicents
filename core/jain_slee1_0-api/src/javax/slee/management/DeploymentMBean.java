 ...
 * <p>
 * The Object Name of a <code>DeploymentMBean</code> object can be obtained by
 * a management client via the {@link SleeManagementMBean#getDeploymentMBean()}
 * method.
 */
public interface DeploymentMBean {
     ...
     * being uninstalled.
     * @param id the identifer of the deployable unit to uninstall.
