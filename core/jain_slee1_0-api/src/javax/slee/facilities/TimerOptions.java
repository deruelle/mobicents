 ...
 * A persistent timer is reinstated when the SLEE restarts after a complete shutdown (due
 * to catastophic failure or operator shutdown).  A non-persistent timer is lost in
 * the same circumstance.
 * <p>
 * Even though a timer can be persistent, its timer events cannot be fired when the SLEE
 * is not running.
 * <p>
 * <b>Timeout</b>
