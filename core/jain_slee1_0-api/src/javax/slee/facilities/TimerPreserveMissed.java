...
public final class TimerPreserveMissed implements Serializable {
     ...
     * @return a <code>TimerPreserveMissed</code> object corresponding to the
     *        <code>preserveMissed</code>.
    ...
    private Object readResolve() throws StreamCorruptedException {
        if (option == PRESERVE_NONE) return NONE;
        if (option == PRESERVE_ALL) return ALL;
        if (option == PRESERVE_LAST) return LAST;
