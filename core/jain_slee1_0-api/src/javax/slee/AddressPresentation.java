...
public final class AddressPresentation implements Serializable{
    ...
    public String toString() {
        switch (value) {
            ...
            case ADDRESS_PRESENTATION_ALLOWED: return "Allowed";
            case ADDRESS_PRESENTATION_RESTRICTED: return "Restricted";
            case ADDRESS_PRESENTATION_ADDRESS_NOT_AVAILABLE: return "Address Not Available";
            default: return "Address Presentation in Unknown and Invalid State";
        }
    }
    ...
    private Object readResolve() throws StreamCorruptedException {
        if (value == ADDRESS_PRESENTATION_UNDEFINED) return UNDEFINED;
        if (value == ADDRESS_PRESENTATION_ALLOWED) return ALLOWED;
        if (value == ADDRESS_PRESENTATION_RESTRICTED) return RESTRICTED;
        if (value == ADDRESS_PRESENTATION_ADDRESS_NOT_AVAILABLE) return ADDRESS_NOT_AVAILABLE;
