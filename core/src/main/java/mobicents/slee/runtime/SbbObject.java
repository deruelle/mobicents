...
public class SbbObject implements Serializable {
    ...
    transient static private Logger log;
    ...
    /** The service container where I live. */
    transient private SleeContainer serviceContainer;

    static {
        log = Logger.getLogger(SbbEntity.class);
     ...
     *  
     */
    public SbbObject(SleeContainer serviceContainer,
            MobicentsSbbDescriptor sbbDescriptor) {

        log = Logger.getLogger(this.getClass());

        // The service container where we reside.
    ...
    public void setState(SbbObjectState state) {
        ...
        if (log.isDebugEnabled()) this.invocationSeq.add(state);
    }
    ...
    /**
     * Setter for property sbbContextobj. The SBB context object is the
     * interface through which the SLEE communicates with the SBB. This method
     * runs in an unspecified transaction context. For now, just ignore any
     * exceptions that are thrown.
     * 
     * @param sbbContext
     *            New value of property sbbContextobj.
     *  
     */

    public void setSbbContext(SbbContextImpl sbbContext) {
        if(log.isDebugEnabled())
            log.debug("setSbbContext " + this.getSbbID());
        if (sbbContext == null)
        ...
        try {
            ...
            if(log.isDebugEnabled())
                log.debug("Exception encountered while setting sbb context ", ex);
        }
    ...
    public void sbbCreate() throws CreateException {
        ...
        if (log.isDebugEnabled()) this.invocationSeq.add("CREATE");
    ...
    public void sbbPostCreate() throws CreateException {
        ...
        if (log.isDebugEnabled()) this.invocationSeq.add("POST CREATE");
    ...
    public void sbbActivate() {
        ...
        if (log.isDebugEnabled()) this.invocationSeq.add("ACTIVATE");
    ...
    public void sbbPassivate() {
        if (log.isDebugEnabled()) this.invocationSeq.add("PASSIVATE");
    ...
    public void sbbLoad() throws TransactionRequiredLocalException {
        ...
        if (log.isDebugEnabled()) this.invocationSeq.add("LOAD");
    ...
    public void sbbExceptionThrown(Exception exception, Object eventObject,
        ...
        try {
            ...
            if (log.isDebugEnabled()) this.invocationSeq.add("EXCEPTION THROWN");
        } finally {
            Thread.currentThread().setContextClassLoader(oldClassLoader);
        }
    ...
    public void sbbRolledBack(RolledBackContext sbbRolledBackContext) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) this.invocationSeq.add("ROLLED BACK");
        } finally {
            Thread.currentThread().setContextClassLoader(oldClassLoader);
        }
    	...
    	if (sbbe != null) {
    		try {
    			...
    			if (usageParameterSet != null) {
    				...
    				String usageParameterInterfaceName = this.getSbbDescriptor()
    				...
    				Method setter = concreteClass.getMethod(
    ...
    private void setUsageParameterTable(SbbEntity sbbe) {
        ...
        if (sbbe != null)
        	usageParameterTable = Service.getUsageParameterTable(sbbe.getServiceId());
