...
public class MobicentsSbbDescriptorInternalImpl implements MobicentsSbbDescriptorInternal, MobicentsSbbDescriptor {
    ...
    public String computeConvergenceName(SleeEvent sleeEvent, ServiceComponent svc)
        ...
        InitialEventSelectorImpl selector = new InitialEventSelectorImpl(
                eventType, sleeEvent.getEventObject(), activity, entry
                        ...
                        .getInitialEventSelectorMethod(), sleeEvent.getAddress() );
        ...
        if (selector.isAddressProfileSelected()) {
            ...
            if (selector.getAddress()== null) {
                ...
                ProfileSpecificationDescriptorImpl profileSpecDescriptor = 
                    (ProfileSpecificationDescriptorImpl) sleeContainer
                ...
                logger.debug("indexes = " + profileSpecDescriptor.getProfileIndexes());
                ...
                Collection profileNames =  sleeProfileManager.getProfilesByIndexedAttribute(addressProfileTable,
    ...
    public void setChildRelationMethods(
        ...
        this.childRelationMethods = new HashMap<String, GetChildRelationMethod>(childRelationMethods.length*2+1); 
    ...
    public GetChildRelationMethod[] getChildRelationMethods() {
        return this.childRelationMethods.values().toArray(new GetChildRelationMethod[this.childRelationMethods.size()]);
    }
    ...
    **/
	...
	public void setupSbbEnvironment() throws Exception {
		...
		for (Iterator it = getResourceAdapterTypeBindings(); it
				.hasNext();) {
		...
		while (iter.hasNext()) {
			...
			if (logger.isDebugEnabled()) {
				logger.debug("Binding environment entry with name:" + ee.getName()
					+ " type  " + entry.getClass() + " with value:" + entry +". Current classloader = "
