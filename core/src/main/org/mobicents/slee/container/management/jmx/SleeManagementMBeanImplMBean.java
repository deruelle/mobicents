 ...
 *
 */
public interface SleeManagementMBeanImplMBean extends 
	SleeManagementMBean, MBeanRegistration, NotificationBroadcaster {
    /**
     ...
     */
    public abstract void stop() throws InvalidStateException, ManagementException;
    ...
    /**
     * @param resourceManagementMBean The resourceManagementMBean to set.
     */
