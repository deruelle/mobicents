The Mobicents JAIN SLEE 1.1 Library Plugin (aka mobicents-library-plugin)
release 1.0
-----------------------------------------------------
...
The Mobicents JAIN SLEE 1.1 Library Plugin is a sub-project of Mobicents.  
Mobicents Library plugin's mission is to build JAIN SLEE 1.1 Library archives.

2. RELEASE INFO

mobicents-library-plugin requires J2SE 1.4 or higher.
...
Latest info is available at the public website: http://www.mobicents.org/

The Mobicents Library Plugin is released under the terms of the GNU Lesser General Public License (see LICENSE.txt).
