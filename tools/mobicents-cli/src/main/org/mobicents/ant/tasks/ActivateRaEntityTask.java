...
public class ActivateRaEntityTask implements SubTask {
    ...
    private static Logger logger = Logger.getLogger(org.mobicents.ant.tasks.ActivateRaEntityTask.class.getName());
    
    public void run(SleeCommandInterface slee) {
		
    	try {
    		// Invoke the operation
    		Object result = slee.invokeOperation("-activateRaEntity", entityName, null, null);
