...
public class CreateProfileTask implements SubTask {
    ...
    private static Logger logger = Logger.getLogger(org.mobicents.ant.tasks.CreateProfileTask.class.getName());

    public void run(SleeCommandInterface slee) {
		
    	try {
    		// Invoke the operation
			Object result = slee.invokeOperation("-createProfile", profileTableName, newProfileName, null);
