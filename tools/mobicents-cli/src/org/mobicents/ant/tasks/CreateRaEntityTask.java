...
public class CreateRaEntityTask implements SubTask {
    ...
    private static Logger logger = Logger.getLogger(org.mobicents.ant.tasks.CreateRaEntityTask.class.getName());
    ...
    public void run(SleeCommandInterface slee) {
    	...
    	try {
			...
			Object result = slee.invokeOperation("-createRaEntity", ra.toString(), entityName, props);
