...
public class LogManagementMBeanUtils {
	...
	public LogManagementMBeanUtils(MBeanServerConnection mbeanServer,
	...
	public void _setDefaultLoggerLevel(Level l)
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "_setDefaultLoggerLevel",
					new Object[] { l },
	...
	public Level _getDefaultLoggerLevel() throws ManagementConsoleException {
		try {
			return (Level) this.mbeanServer.invoke(logMgmtMBeanName,
	...
	public void setDefaultLoggerLevel(String l)
			throws ManagementConsoleException {
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "setDefaultLoggerLevel",
	...
	public void _setDefaultHandlerLevel(Level l)
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName,
					"_setDefaultHandlerLevel", new Object[] { l },
					new String[] { "java.util.logging.Level" });
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils
	...
	public void setDefaultHandlerLevel(String l)
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "setDefaultHandlerLevel",
					new Object[] { l }, new String[] { "java.lang.String" });
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils
	...
	public List<String> getLoggerNames(String regex)
			throws ManagementConsoleException {
		try {
			return (List<String>) this.mbeanServer.invoke(logMgmtMBeanName,
					"getLoggerNames", new Object[] { regex },
	...
	public void setLoggerLevel(String loggerName, Level level)
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "setLoggerLevel",
					new Object[] { loggerName, level }, new String[] {
	...
	public void resetLoggerLevels() throws ManagementConsoleException {
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "resetLoggerLevels",
					null, null);
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils
	...
	public void resetLoggerLevel(String loggerName)
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "resetLoggerLevel",
	...
	public void clearLoggers() throws ManagementConsoleException {
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "clearLoggers", null,
					null);
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils
	...
	public void clearLoggers(String name) throws ManagementConsoleException {
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "clearLoggers",
	...
	public void addSocketHandler(String loggerName, Level handlerLevel,
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "addSocketHandler",
					new Object[] { loggerName, handlerLevel, handlerName,
	...
	public boolean removeHandler(String loggerName, String handlerName)
		...
		try {
			return ((Boolean) this.mbeanServer.invoke(logMgmtMBeanName,
					"removeHandler", new Object[] { loggerName, handlerName },
					new String[] { "java.lang.String", "java.lang.String" }))
					.booleanValue();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public boolean removeHandler(String loggerName, int index)
		...
		try {
			return ((Boolean) this.mbeanServer.invoke(logMgmtMBeanName,
					"removeHandler", new Object[] { loggerName, index },
	...
	public void addNotificationHandler(String loggerName, int numberOfEntries,
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "addNotificationHandler",
					new Object[] { loggerName, numberOfEntries, level,
							formaterClassName, filterClassName }, new String[] {
							"java.lang.String", "int",
	 ...
	 */
	public List getHandlerNamesForLogger(String loggerName)
			throws ManagementConsoleException {
		try {
			return (List) this.mbeanServer.invoke(logMgmtMBeanName,
					"getHandlerNamesForLogger", new Object[] { loggerName },
					new String[] { "java.lang.String" });
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils
	...
	public String getHandlerLevel(String loggerName, String handlerName)
		...
		try {
			return (String) this.mbeanServer.invoke(logMgmtMBeanName,
					"getHandlerLevel",
					new Object[] { loggerName, handlerName }, new String[] {
							"java.lang.String", "java.lang.String" });
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils
	...
	public String getHandlerFilterClassName(String loggerName,
		...
		try {
			return (String) this.mbeanServer.invoke(logMgmtMBeanName,
					"getHandlerFilterClassName", new Object[] { loggerName,
							handlerName }, new String[] { "java.lang.String",
							"java.lang.String" });
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils
	...
	public String getHandlerFormaterClassName(String loggerName,
		...
		try {
			return (String) this.mbeanServer.invoke(logMgmtMBeanName,
					"getHandlerFormaterClassName", new Object[] { loggerName,
							handlerName }, new String[] { "java.lang.String",
							"java.lang.String" });
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getHandlerClassName(String loggerName, String handlerName)
			...
			IllegalStateException, ManagementConsoleException {
		try {
			return (String) this.mbeanServer.invoke(logMgmtMBeanName,
					"getHandlerClassName", new Object[] { loggerName,
							handlerName }, new String[] { "java.lang.String",
							"java.lang.String" });
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getHandlerClassName(String loggerName, int index)
		...
		try {
			return (String) this.mbeanServer.invoke(logMgmtMBeanName,
					"getHandlerClassName", new Object[] { loggerName, index },
	...
	public void setHandlerLevel(String loggerName, String handlerName,
			String level) throws IllegalArgumentException,
			NullPointerException, ManagementConsoleException {

		try {
			this.mbeanServer.invoke(logMgmtMBeanName, "setHandlerLevel",
					new Object[] { loggerName, handlerName, level },
					new String[] { "java.lang.String", "java.lang.String",
							"java.lang.String" });
		} catch (Exception e) {
			e.printStackTrace();
	 ...
	 */
	public void setHandlerLevel(String loggerName, String handlerName,
			Level level) throws ManagementConsoleException {
	...
	public void setHandlerFilterClassName(String loggerName,
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName,
					"setHandlerFilterClassName", new Object[] { loggerName,
							handlerName, className }, new String[] {
							"java.lang.String", "java.lang.String",
							"java.lang.String" });
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void setHandlerFormaterClassName(String loggerName,
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName,
					"setHandlerFormaterClassName", new Object[] { loggerName,
							handlerName, className }, new String[] {
							"java.lang.String", "java.lang.String",
							"java.lang.String" });
		} catch (Exception e) {
	...
	public void setHandlerNotificationInterval(String loggerName,
		...
		try {
			this.mbeanServer.invoke(logMgmtMBeanName,
					"setHandlerNotificationInterval", new Object[] {
							loggerName, numberOfEntries }, new String[] {
							"java.lang.String", "int" });
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils
	...
	public String fetchLog(String loggerName) throws IllegalArgumentException,
		...
		try {
			return (String) this.mbeanServer.invoke(logMgmtMBeanName,
					"fetchLog", new Object[] { loggerName },
					new String[] { "java.lang.String" });
		} catch (Exception e) {
			e.printStackTrace();
			throw new ManagementConsoleException(SleeManagementMBeanUtils
	...
	public boolean getUseParentHandlersFlag(String loggerName)
		...
		try {
			return ((Boolean) this.mbeanServer.invoke(logMgmtMBeanName,
					"getUseParentHandlersFlag", new Object[] { loggerName },
